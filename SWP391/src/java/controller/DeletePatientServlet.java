...
public class DeletePatientServlet extends HttpServlet {
    ...
    throws ServletException, IOException {
        ...
        try (PrintWriter out = response.getWriter()) {
            ...
            out.println("<html>");
            out.println("<head>");
            out.println("<title>Servlet DeletePatientServlet</title>");  
            out.println("</head>");
            out.println("<body>");
            out.println("<h1>Servlet DeletePatientServlet at " + request.getContextPath () + "</h1>");
            out.println("</body>");
            out.println("</html>");
        }
    } 
    ...
    throws ServletException, IOException {
        ...
        ArrayList<Appointment> ls = ad.getAppointmnetByPatient(p);
        
        ServiceAppointmentDAO sad = new ServiceAppointmentDAO();
        for (Appointment l : ls) {
            sad.deleteAllServiceAppointmentByAppointment(l);
        }
        
        // delete appointment by patient
        ad.deleteAllAppointmentByPatients(p);
