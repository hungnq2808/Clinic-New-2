                        ...
                        <div class="tab-content" id="pills-tabContent">
                            <div class="card border-0 shadow overflow-hidden">
                                <div class="tab-content p-4" id="pills-tabContent">
                                    ...
                                    <form action="servicemanage?action=submit" method="POST" enctype="multipart/form-data" class="mt-4" onSubmit="document.getElementById('submit').disabled = true;">
                                        <div class="row">
                                           
                                            <div class="col-lg-12">
                                                <div class="mb-3">
                                                    <label class="form-label">Tên dịch vụ</label>
                                                    <input name="title" oninvalid="CheckTitle(this);"  id="name" type="text" class="form-control" >
                                                </div>
                                            </div>
                                            ...
                                            <div class="col-lg-12">
                                                <div class="mb-3">
                                                    ...
                                                    <input name="price"   id="number" type="number" class="form-control">
                                                </div>
                                            </div>
                                            <div class="col-lg-12">
                                                <div class="mb-3">
