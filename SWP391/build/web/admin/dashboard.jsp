                                        ...
                                        <table class="list-unstyled mb-0 p-4">
                                            ...
                                            <c:forEach items="${appointmentstoday}" var="a">
                                                <tr>
                                                    ...
                                                    <td class="p-3">${a.getDate()}</td>
                                                    <td class="p-3">${a.getSlot().getDate_schedule()}</td>
                                                </tr>
                                            </c:forEach>
                                        </tbody>
                                    </table>
        ...
        <script>
            ...
            <script type="text/javascript">
                    function Astatistic(type) {
                        window.location.href = "dashboard?action=statistic&atype=" + type;
                    }
        </script>
...
<!--        <script>
            var options2 = {
                series: [${Revenuemedicine}, ${Revenueservice}],
                chart: {
                    width: 450,
                    type: 'pie'
                },

                labels: ['Medicine', 'Service'],
                responsive: [{
                        breakpoint: 600,
                        options: {
                            chart: {
