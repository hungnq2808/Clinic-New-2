                                    ...
                                    <div class="bg-white rounded shadow overflow-hidden">
                                        ...
                                        <div class="list-unstyled p-4">
                                            ...
                                            <div class="d-flex align-items-center mt-2">
                                                ...
                                                <p class="text-muted mb-0 ms-2">${patient.patientName}</p>
                                            </div>
                                            <div class="d-flex align-items-center mt-2">
                            ...
                            <div class="tab-pane fade" id="edit" role="tabpanel" aria-labelledby="edit">
                                <div class="card border-0 shadow overflow-hidden">
                                    <div class="tab-content p-4" id="pills-tabContent">
                                        <form action="patient?action=update_patient&pid=${patient.id}" method="POST" class="mt-4" onSubmit="document.getElementById('submit').disabled = true;">
                                            <div class="row">
                                                <div class="col-lg-12">
                                                    <div class="mb-3">
                                                ...
                                                <input hidden name="pid" id="name" type="text" class="form-control" value="${patient.id}">
                                                <div class="col-lg-12">
                                                    <div class="mb-3">
                                                ...
                                                <div class="col-lg-12">
                                                    <div class="mb-3">
                                                        ...
                                                        <input name="email" id="name" type="text" class="form-control" value="${patient.patientEmail}">
                                                    </div>
                                                </div>
                                                <div class="col-lg-12">
                                                    <div class="mb-3">
