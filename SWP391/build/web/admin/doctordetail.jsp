                                            ...
                                            <div class="row">
                                                ...
                                                <div class="col-lg-12">
                                                    <div class="mb-3">
                                                        ...
                                                        <input name="phone" oninvalid="CheckPhone(this);" oninput="CheckPhone(this);" id="number" type="text" class="form-control" value="${doctor.phone}">
                                                    </div>
                                                </div>
                                                <div class="col-lg-12">
                                                    <div class="mb-3">
                                                    ...
                                                    <div class="mb-3">
                                                        ...
                                                        <select name="speciality" class="form-select">
                                                            <c:forEach items="${speciality}" var="s">
                                                                <option <c:if test="${doctor.specialization == s.name}">selected</c:if> class="form-control" value="${s.id}">${s.name}</option>
                                                            </c:forEach>
                                                        </select>
                                                    </div>
                                                </div>
