<%-- 
    Document   : invoice
    Created on : Mar 17, 2023, 12:52:06 AM
    Author     : Quang Anh
--%>
    ...
    <body>
                            ...
                            <div class="dropdown-menu dd-menu dropdown-menu-end bg-white shadow border-0 mt-3 py-3" style="min-width: 200px;">
                                <a class="dropdown-item d-flex align-items-center text-dark" href="doctor-profile.html">
                                    ...
                                    <div class="flex-1 ms-2">
                                        ...
                                        <small class="text-muted">${p.getPatientDob()}</small>
                                    </div>
                                </a>
                        ...
                        <div class="modal-body p-3 pt-4">
                            <div class="row mb-4">
                                <div class="col-lg-8 col-md-6">
                                    ...
                                    <small class="text-muted mb-0">${ls.getUa().getLocation().getName()}</small>
                                </div><!--end col-->

                                <div class="col-lg-4 col-md-6 mt-4 mt-sm-0 pt-2 pt-sm-0">
                                    <ul class="list-unstyled">
                                        <li class="d-flex">
                                            <small class="mb-0 text-danger">Invoice no. : </small>
                                            <small class="mb-0 text-danger">${ls.getClinicCode()}</small>
                                        </li>
                                        ...
                                        <li class="d-flex mt-2">
                                            ...
                                            <small class="mb-0">&nbsp;&nbsp;${ls.getPd().getPatientName()}</small>
                                        </li>
                                    </ul>
                                </div><!--end col-->
                            </div><!--end row-->
                            ...
                            <div class="pt-4 border-top">
                                <div class="row">
                                    <div class="col-lg-8 col-md-6">
                                        ...
                                        <h6>${ls.getUa().getSpecialization().getName()}</h6>
                                    </div><!--end col-->

                                    <div class="col-lg-4 col-md-6 mt-4 mt-sm-0 pt-2 pt-sm-0">
                                        <ul class="list-unstyled">
                                            <li class="d-flex mt-2">
                                                <small class="mb-0 text-muted">Appointment date. : </small>
                                                <small class="mb-0 text-dark">&nbsp;&nbsp; ${ls.getDate()}</small>
                                            </li>

                                            <li class="d-flex mt-2">
                                                <small class="mb-0 text-muted">Dr. Name : </small>
                                                <small class="mb-0 text-dark">&nbsp;&nbsp;Dr. ${ls.getUa().getName()}</small>
                                            </li>
                                        </ul>
                                    </div><!--end col-->
                                </div><!--end row-->

                                <!-- Begin get all service -->

                                <c:if test="${sessionScope.lssa != null}">
                                        ...
                                        <div class="table-responsive shadow rounded mt-4">
                                            <table class="table table-center invoice-tb mb-0">
                                                ...
                                                <tbody>
                                                    ...
                                                    <c:forEach items="${sessionScope.lssa}" var="l">
                                                        <tr>
                                                            <th scope="row" class="text-start p-3">${l.getId()}</th>
                                        ...
                                        <div class="row">
                                            <div class="col-lg-4 col-md-5 ms-auto">
                                                <ul class="list-unstyled h6 fw-normal mt-4 mb-0 ms-md-5 ms-lg-4">
                                                    <li class="d-flex justify-content-between pe-3">Total(VND) :<span> ${sessionScope.total}</span></li>
                                                </ul>
                                            </div><!--end col-->
                                        </div><!--end row-->
                                    </div>
                                ...
                                <c:if test="${sessionScope.lssa == null}">
                                    <h3 class="text-center text-sm-start">maybe you haven't been to a doctor or haven't used any services</h3>
                                </c:if>
                                <div class="border-top pt-4">
                                    <div class="row">
                                        <div class="col-sm-6">
                                            <div class="text-sm-start text-muted text-center">
                                                <a href="#" class="btn btn-soft-primary" data-bs-toggle="modal" data-bs-target="#view-invoice">More Service</a>
                                            </div>
                                        </div><!--end col-->
        ...
        <div class="modal fade" id="view-invoice" tabindex="-1" aria-labelledby="exampleModalLabel" aria-hidden="true">
            <div class="modal-dialog modal-sm modal-dialog-centered">
                <div class="modal-content">
                    <div class="modal-header border-bottom p-3">
                        <h5 class="modal-title" id="exampleModalLabel">More service</h5>
                        <button type="button" class="btn-close" data-bs-dismiss="modal" aria-label="Close"></button>
                    </div>
                    <form action="patientaddmoreservice"> 
                        <div class="modal-body p-3 pt-4">

                           
    <!--                            <input type="checkbox" value="${ser.getId()}"  name="service"/>
                                <label>${ser.getName()}</label>-->
                                <table class="table table-hover">
                                    ...
                                    <tbody>  
                                         <c:forEach items="${sessionScope.lsser}" var="ser">
                                        <tr>
                                            <td><input type="checkbox" value="${ser.getId()}"  name="service"/></td>
                                            <td><label>${ser.getName()}</label></td> 
                                            <td><label>${ser.getPrice()}</label></td> 
                                        </tr>
                                        </c:forEach>
                                    </tbody>
                                </table>
