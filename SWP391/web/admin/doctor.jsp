                                    ...
                                    <div class="justify-content-md-end row">
                                        ...
                                        <div class="col-md-1 md-0">
                                            <button type="submit" class="btn btn-primary">Lọc</button>                                                 
                                                    ...
                                                    <div>
                                                        <a class="btn btn-primary" href="doctormanage?action=add">Add doctor</a>
                                                    </div>
                                </form>
                                    ...
                                    <table class="table mb-0 table-center">
                                        <thead>
                                            <tr>
                                                ...
                                                <th class="border-bottom p-3" >More</th>
                                            </tr>
                                        </thead>
                                        <tbody>
                                            <c:forEach items="${doctor}" var="d">
                                                <tr>
                                                    <th class="p-3">${d.getId()}</th>
                                                    <td class="p-3">${d.getName()}</td>
                                                    <c:if test="${d.isGender() == true}">
                                                        <td class="p-3">Nam</td>
                                                    </c:if>
                                                    <c:if test="${d.isGender() == false}">
                                                        <td class="p-3">Nữ</td>
                                                    </c:if>
                                                    <td class="p-3">${d.getSpecialization().getName()}</td>
                                                    <td class="p-3">
                                                        <a href="doctormanage?action=detail&id=${d.getId()}" type="button"class="btn btn-info">Chi tiết</a>
                                                    </td>
                                                </tr>
                                            </c:forEach>
                                        </tbody>
