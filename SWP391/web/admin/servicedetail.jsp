                                            ...
                                            <div class="row">
                                                <div class="col-lg-12">
                                                    <div class="mb-3">
                                                        ...
                                                        <input name="name" oninvalid="CheckTitle(this);" oninput="CheckTitle(this);" id="name" type="text" class="form-control" value="${service.name}">
                                                    </div>
                                                </div>
                                                ...
                                                <div class="col-lg-12">
                                                    <div class="mb-3">
                                                        ...
                                                        <input name="price" oninvalid="CheckPrice(this);" oninput="CheckPrice(this);"  id="number" type="text" class="form-control" value="${service.price}">
                                                    </div>
                                                </div>
