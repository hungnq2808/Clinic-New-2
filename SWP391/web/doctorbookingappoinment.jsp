                            ...
                            <ul class="submenu">
                                <li class="has-submenu parent-menu-item">
                                    ...
                                    <ul class="submenu">
                                        ...
                                        <li><a href="patientlist.html" class="sub-menu-item">Patients</a></li>
                        ...
                        <div class="text-center">
                            ...
                            <div class="subcribe-form mt-4">
                                <form action="searchpatientprofilebycode">
                                    <div class="mb-0">
                                        <input type="text" id="help" name="code" class="border bg-white rounded-pill" required="" placeholder="Enter Your Code to see your appointment with doctor${pageContext.request.contextPath}${pageContext.request.contextPath}.">
